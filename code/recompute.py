...
Outputs
  <OUT>/results/ncs_results.json
  <OUT>/results/audit_report.json
  <OUT>/results/source_data.csv
"""
...
p1 = os.path.join(RES, "ncs_results.json")
...
p2 = os.path.join(RES, "audit_report.json")
json.dump(AUDIT, open(p2, "w"), indent=1, ensure_ascii=False)

p3 = os.path.join(RES, "source_data.csv")
