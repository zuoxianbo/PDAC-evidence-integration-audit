...
Outputs results/sentinel_audit.json and prints a readable summary.
"""
import json
import os
...
exec(compile(SRC.split(MARK)[0], "recompute.py[1-4]", "exec"), ns)
...
p = os.path.join(RES, "sentinel_audit.json")
