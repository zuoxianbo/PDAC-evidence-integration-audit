...
*Prepared from `the submission-package template`. Placeholders in [brackets] must be completed before submission. Companion items: `author_contributions.md`, `competing_interests.md`, `SUBMISSION_PACKAGE.md`.*
