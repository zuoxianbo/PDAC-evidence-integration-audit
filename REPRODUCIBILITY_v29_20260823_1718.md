...
reproduces every number in the manuscript. See `run_record_v31_20260824.txt`:
...
(pinned in `environment_lock_v29_20260823_1718.txt`).
...
python code/v18_figures_v31_20260823_1830.py
python code/v18_ed_figures_v31_20260823_1830.py
```
...
`final_input_manifest_v29_20260823_1718.csv` so identity can be verified before a
rerun. The harmonised nine-layer evidence table and complete benchmark outputs are
